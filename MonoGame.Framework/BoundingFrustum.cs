...
namespace Microsoft.Xna.Framework
{
    ...
    public class BoundingFrustum : IEquatable<BoundingFrustum>
    {
        ...
        {
            this.Contains(ref box, out ContainmentType result);
            return result;
        }
        ...
        public void Contains(ref BoundingBox box, out ContainmentType result)
        {
            ...
            {
                box.Intersects(ref this._planes[i], out PlaneIntersectionType planeIntersectionType);
        ...
        {
            this.Contains(ref sphere, out ContainmentType result);
            return result;
        }
        ...
        public void Contains(ref BoundingSphere sphere, out ContainmentType result)
        {
            ...
            for (var i = 0; i < PlaneCount; ++i)
            {
                ...
                sphere.Intersects(ref this._planes[i], out PlaneIntersectionType planeIntersectionType);
                switch (planeIntersectionType)
                {
                case PlaneIntersectionType.Front:
                    result = ContainmentType.Disjoint; 
        ...
        {
            this.Contains(ref box, out ContainmentType containment);
        ...
        {
            this.Intersects(ref sphere, out bool result);
            return result;
        }
        ...
        {
            this.Contains(ref sphere, out ContainmentType containment);
            result = containment != ContainmentType.Disjoint;
        }
        ...
        {
            this.Contains(ref ray.Position, out ContainmentType ctype);
