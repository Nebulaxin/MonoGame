...
public struct TouchLocation : IEquatable<TouchLocation>
{
    ...
    internal readonly Vector2 PressPosition
    {
        get { return _pressPosition; }
    }

    internal readonly TimeSpan PressTimestamp
    {
        get { return _pressTimestamp; }
    }

    internal readonly TimeSpan Timestamp
    {
    ...
    internal readonly TouchLocation AsMovedState()
    {
        var touch = this;
    ...
    /// </summary>
    public readonly bool IsHighFrequencyEvent()
    {
    ...
    /// <inheritdoc/>
    public readonly bool Equals(TouchLocation other)
    {
    ...
    public readonly bool TryGetPreviousLocation(out TouchLocation aPreviousLocation)
    {
